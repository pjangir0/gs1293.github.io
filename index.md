...
---
  ...
  <a
  onclick="window.open('https://fossbytes.com/');
  window.open('https://news.google.com/news/')"
  window.open('http://www.espncricinfo.com/')"
  window.open('https://gs1293.github.io/')"
  window.open('https://github.com/')"
  href="https://www.reddit.com/"
  target="_blank">Shortcut to daily reading
  </a>
